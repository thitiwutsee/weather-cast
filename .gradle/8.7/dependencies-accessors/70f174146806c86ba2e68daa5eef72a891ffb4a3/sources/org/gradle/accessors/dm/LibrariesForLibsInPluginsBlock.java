...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class HiltNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hill.navigation.compose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final HillVersionAccessors vaccForHillVersionAccessors = new HillVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>dagger</b> with value <b>2.49</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.hill</b>
         */
        public HillVersionAccessors getHill() {
            return vaccForHillVersionAccessors;
        }
    ...
    public static class HillVersionAccessors extends VersionFactory  {

        private final HillNavigationVersionAccessors vaccForHillNavigationVersionAccessors = new HillNavigationVersionAccessors(providers, config);
        public HillVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.hill.navigation</b>
         */
        public HillNavigationVersionAccessors getNavigation() {
            return vaccForHillNavigationVersionAccessors;
        }

    }

    public static class HillNavigationVersionAccessors extends VersionFactory  {

        public HillNavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>hill.navigation.compose</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompose() { return getVersion("hill.navigation.compose"); }
